...
('Jupiter D&D Guild', 'Tabletop', 'Jupiter', 'A community of storytellers and strategists. From One-Shots to long-term campaigns.', 8, 20, 'https://images.unsplash.com/photo-1615848666533-62fd3d810203?auto=format&fit=crop&q=80', 'All levels', '[26.9342, -80.0942]'),
('Delray Beach Pickleball', 'Sports', 'Delray Beach', 'Casual doubles and local social play. All residents welcome for morning sessions.', 45, 100, 'https://images.unsplash.com/photo-1599586120429-48281b6f0ece?auto=format&fit=crop&q=80', 'Casual', '[26.4615, -80.0728]'),
...
('Lake Worth Strategy Club', 'Tabletop', 'Lake Worth', 'Deep strategy board games and TCG meetups. If it has a rulebook, we play it.', 10, 25, 'https://images.unsplash.com/photo-1606167668584-78701c57f13d?auto=format&fit=crop&q=80', 'Advanced', '[26.6159, -80.0569]'),
